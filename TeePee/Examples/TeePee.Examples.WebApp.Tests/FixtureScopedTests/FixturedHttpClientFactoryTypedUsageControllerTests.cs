...
{
    public class FixturedHttpClientFactoryTypedUsageControllerTests : IClassFixture<HttpClientFactoryTypedUsageControllerFixture>
    {
        private readonly HttpClientFactoryTypedUsageControllerFixture m_Fixture;

        public FixturedHttpClientFactoryTypedUsageControllerTests(HttpClientFactoryTypedUsageControllerFixture fixture)
        {
            m_Fixture = fixture;
    ...
    public class HttpClientFactoryTypedUsageControllerFixture : BaseFixture<HttpClientFactoryTypedUsageController>
    {
        ...
        protected override IServiceCollection ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            return services
                ...
                // Test code
                .AttachToTypedClient<ExampleTypedHttpClient>(TeePeeBuilder);
        }
