...
{
    public class HttpClientFactoryManualInjectionBasicUsageControllerTests
    {
        ...
        public async Task RecommendedPassiveMocking()
        {
            ...
            var controller = new HttpClientFactoryManualInjectionBasicUsageController(m_TeePeeBuilder.Build().CreateHttpClientFactory());
